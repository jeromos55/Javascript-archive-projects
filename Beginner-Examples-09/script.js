...
2. Create an array with both Julia's (corrected) and Kate's date
...
//   dogsJuliaCopy.splice(0, 1); // delete the first element from the array
//   dogsJuliaCopy.splice(-2); // deleted the last two elements from the array
